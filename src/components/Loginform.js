    ...
    return (
        <div className='w-full  pr-20'>
            ...
            <div className='mt-5'>
                ...
                <button onClick={redirectRegister} className="w-full mt-3 px-4 py-2 rounded bg-gradient-to-r from-gred to-gorange hover:bg-secondaryGreen text-white font-semibold text-center block focus:outline-none focus:ring focus:ring-offset-2 focus:ring-primaryGreen">Create an Account</button>
